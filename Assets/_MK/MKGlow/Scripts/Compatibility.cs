...
namespace MK.Glow
{
	public static class Compatibility
    {
        ...
        {
            return SystemInfo.graphicsShaderLevel >= 30 && SystemInfo.supportedRenderTargetCount >= 2 && !PipelineProperties.singlePassStereoInstancedEnabled;
        }
        ...
        {
            return SystemInfo.graphicsShaderLevel >= 40 && SystemInfo.supportedRenderTargetCount >= 6 && !PipelineProperties.singlePassStereoInstancedEnabled;
        }
